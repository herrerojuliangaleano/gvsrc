...
(function () {
    ...
    function setupTabs(root) {
        ...
        tablists.forEach(function (tablist) {
            if (tablist.getAttribute('data-gv-tabs-ready') === 'true') return;
            tablist.setAttribute('data-gv-tabs-ready', 'true');
            ...
            function activate(tab, focusIt) {
                ...
                // Sync the underlying radio (CSS-only fallback) if present
                var forId = tab.getAttribute('for');
                if (forId) {
